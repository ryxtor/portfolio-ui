    ...
    <section className="text-gray-700 body-font relative bg-gray-200">
      <div className="container px-5 py-14 mx-auto">
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <form action="https://formspree.io/f/xyyvgnan" method="POST" className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              ...
              <span className="inline-flex">
                <a href="google.com" className="text-gray-500">
                  <svg
                    fill="currentColor"
                    strokeLinecap="round"
                ...
                <a href="googl.com" className="ml-4 text-gray-500">
                  <svg
                    fill="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
